...
/**
 * Divide and return quotient as well as the remainder
 */
function divrem(dividend, divisor) {
    ...
    // We estimate the next digit of the quotient. We subtract the divisor times that
    // estimate from the dividend, and then we go again. We are using base 16777216
...
/**
 * Divide but return only the quotient
 */
...
function power(big, exponent) {
    ...
    // only supporting positive exponents
...
/**
 * For to and from convertions of numbers and strings
 */
...
/**
 * Convert a big integer to string
 */
